...
# We want to replace the table container with a conditional rendering.
# Let's find the start of the table container:
# <div className="overflow-x-auto">
#   <table ...

target = r"(<div className=\"overflow-x-auto\">\s*<table className=\"w-full text-left border-collapse text-xs\">)"

rekap_ui = """
      {statusFilter === 'Rekap Kuota Cuti' ? (
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden p-6 mb-6">
