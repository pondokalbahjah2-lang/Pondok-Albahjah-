  ...
  React.useEffect(() => {
    if (currentUser.role === 'Pejuang') {
      ...
      if (myWarnings.length > 0) {
        // Sort descending
        myWarnings.sort((a, b) => new Date(b.tanggal || b.createdAt || 0).getTime() - new Date(a.tanggal || a.createdAt || 0).getTime());
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 15 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 15 }} transition={{ type: "spring", stiffness: 500, damping: 35, mass: 0.6 }}
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
              Anda menerima <strong>Surat Teguran</strong> baru dari Admin pada tanggal {activeWarning.tanggal || activeWarning.date}.
            </p>
